  ...
  return (
    <div className={styles.body}>
      ...
      <main>
        ...
        <p>
          In addition to its intriguing musical influences, the albums stand out
          for their narrative concept that spans all three records, referencing
          tarot, Buddhism, and ancient myths, forming what they call the
          "Esoteric Trilogy." Tarot Funk portrays the last moments before
          nemanja's death through tarot cards and sounds inspired by 70s
          Anatolian rock; Cosmic Disco follows nemanja's journey through the
          bardo, the underworld, guided by the Tibetan Book of the Dead, with
          influences from African and Asian disco of the 70s and 80s; and Voodoo
          Beat concludes the "Esoteric Trilogy," where nemanja attempts to
          return from the land of the dead with the help of voodoo powers of
          love and an Afro-Colombian sound.
        </p>
        <p>
